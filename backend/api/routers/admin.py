...
from backend.api.middleware.admin_auth import admin_auth
from backend.models.user import UserRole
from backend.models.admin import (
    ModelInfo, ModelDeployRequest, PaperStats, PaperSource,
    EvaluationRun, EvaluationRequest, SystemHealth, AirflowDAG,
    CostData
)
...
async def list_models(
    request: Request,
    credentials=Depends(admin_auth.security)
) -> List[ModelInfo]:
